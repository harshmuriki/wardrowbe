...
class UserFeedback(Base):
    ...
    actually_worn: Mapped[Optional[bool]] = mapped_column(Boolean, nullable=True)
    wore_instead_items: Mapped[Optional[list]] = mapped_column(JSONB, nullable=True)  # List of item UUIDs worn instead
